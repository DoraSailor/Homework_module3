# Ансамблевые методы. В основе — идея объединения нескольких переобученных (!) моделей для уменьшения эффекта переобучения.
# Это называется баггинг (bagging).
# Баггинг усредняет результаты —> оптимальнjq классификация.

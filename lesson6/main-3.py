...
# В PCA выполняется качественная оценка этой зависимости путём поиска главных осей координат
# и их использования для описания наборов данных.
...
# Достоинства: простота интерпретации, эффективность в работе с многомерными данными.
# Недостаток: аномальные значения в данных оказывают сильное влияние.
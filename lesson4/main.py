...
# теорема баеса из теории вероятностей
...
plt.scatter(X_p_setosa["sepal_length"], X_p_setosa["petal_length"], alpha=0.4,color='blue')
plt.scatter(X_p_versicolor["sepal_length"], X_p_versicolor["petal_length"], alpha=0.4,color='r')
plt.scatter(X_p_virginica["sepal_length"], X_p_virginica["petal_length"], alpha=0.4,color='m')
